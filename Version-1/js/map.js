...
//Info Windows
      ...
      var template3 = new InfoTemplate();
        ...
        template3.setContent("<b>Well Depth:</b> ${TotalDepth}</br> </br><button type='button' id='graphButton' class='btn btn-default' data-toggle='modal' data-target='#Graph'>Graph</button>");
